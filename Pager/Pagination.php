...
class Pagination {
  ...
  public function display ($split=5) {
    ...
    if ($current_page != 1) {
      $html .= '<a class="" title="First" href="' . $page->url('add', $url, 's', 0) . '"></a>';
      $html .= '<a class="" title="Previous" href="' . $page->url('add', $url, 's', $this->start - $this->display) . '">Previous</a>';
    } else {
    ...
    if ($current_page != $this->num_pages) {
      $html .= '<a class="" title="Next" href="' . $page->url('add', $url, 's', $this->start + $this->display) . '">Next</a>';
      $last = ($this->num_pages * $this->display) - $this->display;
      $html .= '<a class="" title="Last" href="' . $page->url('add', $url, 's', $last) . '"></a>';
    } else {

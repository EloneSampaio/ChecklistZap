...
session_start();
if((!isset($_SESSION['admin'])==TRUE) and (!isset($_SESSION['pass'])==TRUE)){
...
$consulta=  htmlentities($_GET["pesquisar"]);
...
<html lang="en">
    <head>
        ...
        <script type='text/javascript' src="views/js/jquery.js.js"></script>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" role="button" data-toggle="dropdown" href="#">
                  <i class="glyphicon glyphicon-user"></i> Olá |<?php echo $logado ?> <span class="caret">
...
<div class="container">
  ...
  <div class="row">
	<div class="col-md-3">
      <!-- left -->
      <a href="admin.php"><img src="views/fonts/zap.jpg " class="img-thumbnail" ></a> 
      <hr>
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="?page=deletar.php"><i class="glyphicon glyphicon-remove"></i> Apagar Checklist</a></li>
        <li><a href="?page=alterar.php"><i class="glyphicon glyphicon-briefcase"></i> Alterar checklist</a></li>
        <li><a href="?page=usuarios.php"><i class="glyphicon glyphicon-briefcase"></i> Usuarios</a></li>
